...
```{r}
correlation_result <- cor(analysis_data$sentiment_score, analysis_data$volatility, use = "complete.obs")
...
ggplot(analysis_data, aes(x = sentiment_score, y = volatility)) +
  ...
  labs(title = "Correlation between Daily Sentiment and Market Volatility", x = "Sentiment Score", y = "Volatility")
```
